    ...
    <div class="collapse navbar-collapse">
        ...
        <ul class="navbar-nav navbar-nav-icons ms-auto flex-row">
                        ...
                        <div class="card-body pt-3 px-3 pb-0 overflow-auto scrollbar" style="height: 20rem;">
                            <div class="row text-center align-items-center gx-0 gy-0">
                                <div class="col-4"><a
                                        ...
                                        href="#!" target="_blank"><img src="{{asset('dashassets/img/nav-icons/behance.png') }}"
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img src="{{asset('dashassets/img/nav-icons/bitbucket.png') }}"
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img src="{{asset('dashassets/img/nav-icons/twitter.png') }}"
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img src="{{asset('dashassets/img/nav-icons/pinterest.png') }}"
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img src="{{asset('dashassets/img/nav-icons/linkedin.png') }}"
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img src="{{asset('dashassets/img/nav-icons/spotify.png') }}"
                                            alt="" width="30">
            ...
            <li class="nav-item dropdown"><a class="nav-link lh-1 px-0 ms-5" id="navbarDropdownUser" href="#"
                    ...
                    <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('dashassets/img/team/57.png') }}"
                            alt=""></div>
                </a>
