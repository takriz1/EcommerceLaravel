          ...
          <div class="pb-5">
            <div class="row g-5">
                ...
                <div class="form-group">
                   ...
                   <input type="text" value="{{auth()->user()->name}}" name="nom" class="form-control">
                </div>
                <div class="form-group">
                    <label for="">Email</label>
                   <input type="email" value="{{auth()->user()->email}}" name="mail" class="form-control">
                </div>
                <div class="form-group">
                    <label for="">Password</label>
                   <input type="password"  name="pw" class="form-control" placeholder="New Password">
                </div>
                <div class="form-group">
