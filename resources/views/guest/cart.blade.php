            ...
            <table class="table table-bordered text-center mb-0">
                ...
                <tbody class="align-middle">
                    ...
                    <tr>
                        ...
                        <td class="align-middle"><img src="{{ asset('uploads') }}/{{$lc->products->image}} "alt="" style="width: 50px;"> {{$lc->products->name}}</td>
                        <td class="align-middle">{{$lc->products->price}} TND</td>
                        <td class="align-middle">
                            {{$lc->qte}}
                        </td>
                        <td class="align-middle">{{$lc->products->price * $lc->qte}} TND</td>
